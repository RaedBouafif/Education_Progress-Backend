...
exports.justifyAbsence = async (req,res) => {
    try{
        ...
        const justifiedAbsence = await StudentAbsence.findOneAndUpdate({ sessionId : sessionId, student : studentId, group : gorupId}, { justified : true}, {new: true, runValidators : true})
        if(!justifiedAbsence){
